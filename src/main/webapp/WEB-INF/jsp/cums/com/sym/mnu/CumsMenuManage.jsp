...
<%
  ...
  */
  /* Image Path 설정 */
  String imagePath_icon   = "/images/egovframework/cum/sym/mnu/mpm/icon";
...
<div class="container-fluid px-4">
	<form name="menuManageForm" action ="<c:url value='/sym/mnu/mpm/CumsMenuManageSelect.do'/>" method="post">
