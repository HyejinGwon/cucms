...
import egovframework.cums.sym.prm.service.impl.CumsProgrmManageDAO;

@Service("cumsMenuManageService")
public class CumsMenuManageServiceImpl extends EgovAbstractServiceImpl implements CumsMenuManageService {

	private static final Logger LOGGER = LoggerFactory.getLogger(CumsMenuManageServiceImpl.class);
	
	@Resource(name="cumsMenuManageDAO")
	private CumsMenuManageDAO menuManageDAO;
	@Resource(name="cumsProgrmManageDAO")
	private CumsProgrmManageDAO progrmManageDAO;
	 ...
	 * @exception Exception
	 */
	public void insertMenuManage(CumsMenuManageVO vo) throws Exception {
	 ...
	 * @exception Exception
	 */
	public void updateMenuManage(CumsMenuManageVO vo) throws Exception {
	 ...
	 * @exception Exception
	 */
	public void deleteMenuManage(CumsMenuManageVO vo) throws Exception {
	 ...
	 * @exception Exception
	 */
	public String menuBndeRegist(CumsMenuManageVO vo, InputStream inputStream) throws Exception {
	 ...
	 * @exception Exception
	 */
	private boolean insertProgrm(CumsProgrmManageVO vo) throws Exception {
	 ...
	 * @exception Exception
	 */
	private boolean insertMenuManageBind(CumsMenuManageVO vo) throws Exception {
		menuManageDAO.insertMenuManage(vo);
		return true;
	}
