package egovframework.cums.sym.mnu.mpm.web;
...
import egovframework.cums.sym.mnu.mpm.service.CumsMenuManageService;
...
@Controller
public class CumsMenuManageController {

	private static final Logger LOGGER = LoggerFactory.getLogger(CumsMenuManageController.class);

	/* Validator */
	@Autowired
	private DefaultBeanValidator beanValidator;
	
	/** EgovPropertyService TODO PropertyService 전자정부말고 Cums로 만들기 시간적 여유가 될 때. */
	@Resource(name = "propertiesService")
	protected EgovPropertyService propertiesService;
	
	/** EgovMenuManageService */
	@Resource(name = "cumsMenuManageService")
	private CumsMenuManageService menuManageService;
	
	/** EgovMenuManageService */
	@Resource(name = "cumsProgrmManageService")
	private CumsProgrmManageService cumsProgrmManageService;
	
	/** EgovMessageSource  TODO MessageSource 전자정부말고 Cums로 만들기 시간적 여유가 될 때.  */
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuManageListDetailSelect.do")
	public String selectMenuManage(
		...
		CumsMenuManageVO resultVO = menuManageService.selectMenuManage(searchVO);
		model.addAttribute("cumsMenuManageVO", resultVO);
	...
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuManageSelect.do")
	public String selectMenuManageList(
		...
		return "cums/com/sym/mnu/CumsMenuManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sym/mnu/mpm/CumsMenuManageListDelete.do")
	public String deleteMenuManageList(
		@RequestParam("checkedMenuNoForDel") String checkedMenuNoForDel,
		@ModelAttribute("cumsMenuManageVO") CumsMenuManageVO menuManageVO,
		ModelMap model)
		throws Exception {
		// 0. Spring Security 사용자권한 처리
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
	...
	public String insertMenuManage(
		...
		if (sCmd.equals("insert")) {
			...
			if (menuManageService.selectMenuNoByPk(menuManageVO) == 0) {
				...
				if (cumsProgrmManageService.selectProgrmNMTotCnt(searchVO) == 0) {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuDetailSelectUpdt.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuManageDelete.do")
	...
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListSelect.do")
	public String selectMenuList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		//        model.addAttribute("resultMsg", resultMsg);
		return "cums/com/sym/mnu/CumsMenuList"; 
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListInsert.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListUpdt.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListDelete.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListSelectMvmn.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuListSelectMvmnNew.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuBndeAllDelete.do")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mpm/CumsMenuBndeRegist.do")
