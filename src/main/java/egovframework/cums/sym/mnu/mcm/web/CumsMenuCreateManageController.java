package egovframework.cums.sym.mnu.mcm.web;
...
import egovframework.cums.sym.mnu.mcm.service.CumsMenuCreateManageService;
...
@Controller
public class CumsMenuCreateManageController {
	...
	@Resource(name = "cumsMenuCreateManageService")
	private CumsMenuCreateManageService menuCreateManageService;
	...
	@RequestMapping(value = "/sym/mnu/mcm/CumsMenuCreatManageSelect.do")
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		*/
		...
		return "cums/com/sym/mnu/CumsMenuCreatManage";
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/CumsMenuCreatSelect.do")
	public String selectMenuCreatList(@ModelAttribute("cumsMenuCreatVO") CumsMenuCreatVO menuCreatVO, ModelMap model) throws Exception {
		// 0. Spring Security 사용자권한 처리
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
			model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
		...
		return "cums/com/sym/mnu/mcm/CumsMenuCreat";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sym/mnu/mcm/CumsMenuCreatInsert.do")
	public String insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert, @RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
			@ModelAttribute("cumsMenuCreatVO") CumsMenuCreatVO menuCreatVO, ModelMap model) throws Exception {
		String resultMsg = "";
		// 0. Spring Security 사용자권한 처리
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
		...
		model.addAttribute("resultMsg", resultMsg);
		return "forward:/sym/mnu/mcm/CumsMenuCreatSelect.do";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/CumsMenuCreatSiteMapSelect.do")
	public String selectMenuCreatSiteMap(@ModelAttribute("cumsMenuCreatVO") CumsMenuSiteMapVO menuSiteMapVO, ModelMap model) throws Exception {
		// 0. Spring Security 사용자권한 처리
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
			model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
		...
		return "cums/com/sym/mnu/mcm/CumsMenuCreatSiteMap";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/CumsMenuCreatSiteMapInsert.do")
	public String selectMenuCreatSiteMapInsert(@ModelAttribute("cumsMenuCreatVO") CumsMenuSiteMapVO menuSiteMapVO, @RequestParam("valueHtml") String valueHtml, ModelMap model
		...
		String currentPath = CumsMenuCreateManageController.class.getProtectionDomain().getCodeSource() == null ? "" : EgovStringUtil.isNullToString(CumsMenuCreateManageController.class.getProtectionDomain().getCodeSource().getLocation().getPath());
		//System.out.println("===>>> currentPath = "+currentPath);
		String path = currentPath.substring(0, currentPath.lastIndexOf("WEB-INF"));
		menuSiteMapVO.setTmpRootPath(path);
		menuSiteMapVO.setBndeFilePath("/html/cums/com/sym/mnu/mcm/");
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/CumsSiteMap.do")
	public String selectSiteMap(@ModelAttribute("cumsMenuCreatVO") CumsMenuSiteMapVO menuSiteMapVO, ModelMap model) throws Exception {
		// 0. Spring Security 사용자권한 처리
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
		if (!isAuthenticated) {
			model.addAttribute("message", egovMessageSource.getMessage("fail.common.login"));
		...
		model.addAttribute("resultVO", menuSiteMapVO);
		return "cums/com/sym/mnu/mcm/CumsSiteMap";
	}
