package egovframework.cums.sym.mnu.mcm.service;
 ...
 * </pre>
 */
public interface CumsMenuCreateManageService {
	/**
	 * ID 존재여부를 조회
	 ...
	 * @exception Exception
	 */
	CumsMenuCreatVO selectAuthorByUsr(ComDefaultVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	List<?> selectMenuCreatList(CumsMenuCreatVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	List<?> selectMenuCreatSiteMapList(CumsMenuSiteMapVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	 List<?> selectSiteMapByUser(CumsMenuSiteMapVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	 boolean creatSiteMap(CumsMenuSiteMapVO vo, String vHtmlValue) throws Exception;
}
