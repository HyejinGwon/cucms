 ...
 * </pre>
 */
@Service("cumsMenuCreateManageService")
public class CumsMenuCreateManageServiceImpl  extends EgovAbstractServiceImpl implements CumsMenuCreateManageService {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(CumsMenuCreateManageServiceImpl.class);
	
	@Resource(name="cumsMenuCreateManageDAO")
	private CumsMenuCreateManageDAO menuCreateManageDAO;
	 ...
	 * @exception Exception
	 */
	public boolean creatSiteMap(CumsMenuSiteMapVO menuSiteMapvo, String vHtmlValue) throws Exception {
		boolean chkCreat = false;
		String vSiteMapName = null;
		int SiteMapCnt = 0;
		//String newMapCreatId = null;
		CumsMenuCreatVO menuCreatVO = new CumsMenuCreatVO();
