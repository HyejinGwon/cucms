 ...
 * </pre>
 */
@Service("CumsBBSSatisfactionService")
public class CumsBBSSatisfactionServiceImpl extends EgovAbstractServiceImpl implements CumsBBSSatisfactionService {

    @Resource(name = "CumsBBSAddedOptionsDAO")
    private CumsBBSAddedOptionsDAO addedOptionsDAO;
    
    @Resource(name = "CumsBBSSatisfactionDAO")
    private CumsBBSSatisfactionDAO bbsSatisfactionDAO;
     ...
     * 만족도조사에 대한 목록을 조회 한다.
     */
    public Map<String, Object> selectSatisfactionList(CumsSatisfactionVO satisfactionVO) throws Exception {
	List<CumsSatisfactionVO> result = bbsSatisfactionDAO.selectSatisfactionList(satisfactionVO);
