package egovframework.cums.cop.cmt.web;
...
@Controller
public class CumsArticleCommentController {
    ...
    public String selectArticleCommentList(@ModelAttribute("searchVO") CumsCommentVO commentVO, ModelMap model) throws Exception {
...
//		commentVO.setSubPageSize(propertyService.getInt("pageSize"));
    ...
    public String insertArticleComment(@ModelAttribute("searchVO") CumsCommentVO commentVO, @ModelAttribute("comment") CumsComment comment, 
		...
		if (isAuthenticated) {
		    ...
		    cumsArticleCommentService.insertArticleComment(comment);
    ...
    public String deleteArticleComment(@ModelAttribute("searchVO") CumsCommentVO commentVO, @ModelAttribute("comment") CumsComment comment, 
		...
		if (isAuthenticated) {
		    cumsArticleCommentService.deleteArticleComment(commentVO);
		}
    ...
    public String updateArticleCommentView(@ModelAttribute("searchVO") CumsCommentVO commentVO, ModelMap model) throws Exception {
	...
	articleCommentVO = cumsArticleCommentService.selectArticleCommentDetail(commentVO);
    ...
    public String updateArticleComment(@ModelAttribute("searchVO") CumsCommentVO commentVO, @ModelAttribute("comment") CumsComment comment, 
		...
		if (isAuthenticated) {
		    ...
		    cumsArticleCommentService.updateArticleComment(comment);
